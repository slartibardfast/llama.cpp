...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_TURBO_2B      = 41, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO_3B      = 42, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO_4B      = 43, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TURBO_5B      = 44, // except 1d tensors
