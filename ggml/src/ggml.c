...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q4_0_AR16:     wtype = GGML_TYPE_Q4_0_AR16;  break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q4_0_AR16: result = quantize_q4_0_ar16(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
