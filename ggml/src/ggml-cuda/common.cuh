...
template<>
struct ggml_cuda_type_traits<GGML_TYPE_Q4_0_AR16> {
    static constexpr int qk = QK4_0_AR16;
    static constexpr int qr = QR4_0_AR16;
    static constexpr int qi = QI4_0_AR16;
};
