...
#pragma unroll
            for (int i0 = 0; i0 < I; i0 += warp_size) {
                ...
                // Load tiles are packed linearly: one int32 per 4 int8 elements, so the
                // weight pointer for element k0 is the int32 at index k0. k00 selects the
                // row half (0 or MMQ_TILE_NE_K) and k01 steps within it.
