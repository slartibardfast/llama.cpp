...
static const ggml_type all_types[] = {
    ...
    GGML_TYPE_TURBO_2B, GGML_TYPE_TURBO_3B, GGML_TYPE_TURBO_4B, GGML_TYPE_TURBO_5B,
                                        ...
                                        for (int kv : { 113, 512, 1024, }) {
                                            ...
                                            for (int nb : { 1, 3, 32, 75, }) {
                                                for (ggml_prec prec : {GGML_PREC_F32, GGML_PREC_DEFAULT}) {
                                                    ...
                                                    for (ggml_type type_KV : {GGML_TYPE_F32, GGML_TYPE_F16, GGML_TYPE_BF16, GGML_TYPE_Q8_0, GGML_TYPE_Q5_1, GGML_TYPE_Q5_0, GGML_TYPE_Q4_1, GGML_TYPE_Q4_0, GGML_TYPE_IQ4_NL, GGML_TYPE_TQ_V_4B}) {
