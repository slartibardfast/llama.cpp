...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // NextN/MTP tensors — per-layer (appended after main layers for MTP-capable archs)
    // Qwen3.5 dense + MoE actually use these; upstream archs (GLM4-MoE, BailingMoe2,
    // DeepSeek2) load them as LAYER_REPEATING with TENSOR_SKIP to satisfy tensor count.
