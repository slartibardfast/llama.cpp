...
llama_kv_cache_iswa::llama_kv_cache_iswa(
    ...
    kv_base = std::make_unique<llama_kv_cache>(
            ...
            0, LLAMA_SWA_TYPE_NONE, residual_window, residual_window_type_k, filter_base, reuse);
    ...
    kv_swa = std::make_unique<llama_kv_cache>(
            ...
            hparams.n_swa, hparams.swa_type, /*residual_window=*/ 0, GGML_TYPE_F16, filter_swa, reuse);
}
